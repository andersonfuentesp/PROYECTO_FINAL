...
<body>
					...
					<div class="col-sm-6 ">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href=""><i class="fa fa-phone"></i> +51 956 393 447</a></li>
								<li><a href=""><i class="fa fa-envelope"></i> anderson.fuentes@ieee.org</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
                                                            <li><a href=""><i class="fa fa-user"></i><%out.print(session.getAttribute("usuario")); %></a></li>
								<li><a href=""><i class="fa fa-star"></i> Lista de deseos</a></li>
								<li><a href="checkout.jsp"><i class="fa fa-crosshairs"></i> Revisar</a></li>
								<li><a href="cart.jsp"><i class="fa fa-shopping-cart"></i> Carrito</a></li>
								<li><a href="logout.do"><i class="fa fa-lock"></i> Salir</a></li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<li><a href="shop.jsp">Inicio</a></li>
								<li class="dropdown"><a href="#" class="active">Tienda<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="checkout.jsp">Revisar</a></li> 
										<li><a href="cart.jsp">Carrito</a></li> 
										<li><a href="logout.do">Salir</a></li> 
                                    </ul>
                                </li> 
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2020 MARKETAPP Inc. All rights reserved.</p>
					<p class="pull-right">Desarrollado por <span><a target="_blank" href="https://pe.linkedin.com/in/anderson-fuentes-133908124">Anderson Fuentes</a></span></p>
				</div>
			</div>
		</div>
