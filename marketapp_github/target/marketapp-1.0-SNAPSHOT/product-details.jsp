					...
					<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<span>
									<span>PEN S/. <%= producto.getPrecio() %></span>
								...
								<p><b>Condición:</b> Nuevo producto</p>								
                                                                <p><b>Descripción:</b> <%= producto.getDescripcion() %></p>
								<a href="https://www.autonoma.pe/" target="_blank"><img src="images/product-details/share.png" class="share img-responsive"  alt="" /></a>
